            ...
            <div class="ozn-form-inner">
                <div class="tr" data-oznform-area="title">
                    ...
                    <div class="ozn-check vertical">
                        <label>
                            <input type="radio" name="title" value="設代行: 標準テンプレートで設置">
                            設置代行: 標準テンプレートで設置
                        </label>
                        <label>
                ...
                <div class="tr" data-oznform-area="form_op">
                    <div class="th">オプション <span class="ozn-label optional">任意</span></div>
                    <div class="td">
                        <div class="ozn-check vertical">
                            <label>
                                <input type="checkbox" name="form_op[]" value="オプション1">
                                オプション1
                            </label>
                            <label>
                                <input type="checkbox" name="form_op[]" value="オプション2">
                                オプション2
                            </label>
                            <label>
                                <input type="checkbox" name="form_op[]" value="その他">
                                その他
                            </label>
                        </div>
                        <div class="form_op-error"></div>
                    </div>
                </div>
                <div class="tr" data-oznform-area="form_op_req">
                    <div class="th">オプション要望 <span class="ozn-label optional">任意</span></div>
                    <div class="td">
                        <input type="text" name="form_op_req" class="ozn-input" autocomplete="organization">
                        <p class="ozn-notice">その他のオプションを選択された場合のみ必須です。</p>
                    </div>
                </div>
                <div class="tr" data-oznform-area="form_op_req">
                    <div class="th">テスト項目１ <span class="ozn-label optional">任意</span></div>
                    <div class="td">
                        <input type="text" name="test01" class="ozn-input" autocomplete="organization">
                    </div>
                </div>
                <div class="tr" data-oznform-area="form_op_req">
                    <div class="th">テスト項目２ <span class="ozn-label optional">任意</span></div>
                    <div class="td">
                        <input type="text" name="test02" class="ozn-input" autocomplete="organization">
                    </div>
                </div>
