...
$account  = "1a19ca0d59ac40";
$password = "ab280c47506a94";
...
// Gmail ReCAPTCHA
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
$googleReCaptchaSecret = '6LeNZrEUAAAAAHLjI-KhXiAsa5n8-Ko7x3z9mXGq';
...
■企業名・団体名フリガナ： <%% halfsize %%><% corporate_kana %><%% endhalfsize %%><%% endif %%>
