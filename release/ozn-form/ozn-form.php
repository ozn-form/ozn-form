 ...
 *       2.9.0 PHP7.4 ~ PHP8.4まで対応・依存ライブラリアップデート (2025.9)
 *       2.9.1 samples/normal/ アクセシビリティ改善 (2025.10)
 *       2.9.2 電話番号バリデーション改善 (2026.03)
 *       2.9.3 DatePicker選択直後の誤バリデーションを防ぐため、onClose後に対象フィールドを再検証 (2026.05)
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
const VERSION = '2.9.3';
